...
fout = R.TFile("rootfiles/MCTrueFakeLepHad.root", "RECREATE")
...
def getMCTrueFakeRate(tauTruth, trigger, prong, all=False):
    region = "n_btag == 2 && n_jets >= 2 && mBB > 150000. && mTW > 40000. && is_fake"
    path = "../fr-ntuple-v17/ttbarIncl.root"
    ...
    c.SaveAs(f"plots/test/c_MCTrueFakeRateLepHad_{CharTauTruth}_{trigger}_{prong}.png")
