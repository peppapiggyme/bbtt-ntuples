...
# rwt_mtw = TTbarInclPlot(rwt, "mTW", "weight", (200, 40000, 240000), array.array(
...
# rwt_stlephad = TTbarInclPlot(rwt, "STlephad", "weight", (1000, 20000, 820000), array.array(
...
# rwt_mtw = TTbarInclPlot(rwt, "mTW", "weight_new", (200, 40000, 240000), array.array(
#     'd', [i for i in range(50000, 260000, 10000)]))
