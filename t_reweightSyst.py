...
drawStack(rwt_cn.nominalPlot(), "m_{T}^{W} [MeV]", regionTeX, f"plots/after/stack_mtw_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())
...
rwt_cn = TTbarSystPlotCollection(rwt, "ST", "RW_", "_new", variations, (2000, 0, 2000000), array.array(
    'd', [i for i in range(0, 2050000, 50000)]))
drawStack(rwt_cn.nominalPlot(), "H_{T} [MeV]", regionTeX, f"plots/after/stack_st_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())
...
drawStack(rwt_cn.nominalPlot(), "e/#mu p_{T} [MeV]", regionTeX, f"plots/after/stack_lep_ptlow_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "b0_pt", "RW_", "_new", variations, (40, 50000, 250000))
drawStack(rwt_cn.nominalPlot(), "leading b-jet p_{T} [MeV]", regionTeX, f"plots/after/stack_b0_ptlow_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "b1_pt", "RW_", "_new", variations, (36, 20000, 200000))
drawStack(rwt_cn.nominalPlot(), "sub-leading b-jet p_{T} [MeV]", regionTeX, f"plots/after/stack_b1_ptlow_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "tau_pt", "RW_", "_new", variations, (36, 20000, 200000))
drawStack(rwt_cn.nominalPlot(), "#tau_{had} p_{T} [MeV]", regionTeX, f"plots/after/stack_tau_ptlow_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())
...
drawStack(rwt_cn.nominalPlot(), "e/#mu p_{T} [MeV]", regionTeX, f"plots/after/stack_lep_pt_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "b0_pt", "RW_", "_new", variations, (980, 20000, 1000000), array.array(
    'd', [20000, 30000, 40000, 50000, 60000, 70000, 90000, 120000, 160000, 250000, 400000, 1000000]))
drawStack(rwt_cn.nominalPlot(), "leading b-jet p_{T} [MeV]", regionTeX, f"plots/after/stack_b0_pt_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())
...
drawStack(rwt_cn.nominalPlot(), "sub-leading b-jet p_{T} [MeV]", regionTeX, f"plots/after/stack_b1_pt_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "tau_pt", "RW_", "_new", variations, (980, 20000, 1000000), array.array(
    'd', [20000, 30000, 40000, 50000, 60000, 70000, 90000, 120000, 160000, 250000, 1000000]))
drawStack(rwt_cn.nominalPlot(), "#tau_{had} p_{T} [MeV]", regionTeX, f"plots/after/stack_tau_pt_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "n_jets", "RW_", "_new", variations, (11, 2, 13))
drawStack(rwt_cn.nominalPlot(), "N_{jets}", regionTeX, f"plots/after/stack_njets_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "mBB", "RW_", "_new", variations, (40, 0, 400000))
drawStack(rwt_cn.nominalPlot(), "m_{bb} [MeV]", regionTeX, f"plots/after/stack_mbb_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())

rwt_cn = TTbarSystPlotCollection(rwt, "mHH", "RW_", "_new", variations, (40, 200000, 2200000))
drawStack(rwt_cn.nominalPlot(), "m_{hh} [MeV]", regionTeX, f"plots/after/stack_mhh_fr_os" + suffix_syst, systs=rwt_cn.systematicPlots())
