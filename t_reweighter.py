...
# rwt.applyWeight(("tau_pt", os.path.join(os.getcwd(), "include", "Reweight1D.h")))

# # After reweighting
# # ------------------

# rwt_lep_pt = TTbarInclPlot(rwt, "lep_pt", "weight_new", (980, 20000, 1000000), array.array(
#     'd', [20000, 30000, 40000, 50000, 60000, 70000, 90000, 120000, 160000, 250000, 1000000]))
# rwt_met = TTbarInclPlot(rwt, "MET", "weight_new", (500, 0, 400000), array.array(
#     'd', [i for i in range(0, 420000, 20000)]))
