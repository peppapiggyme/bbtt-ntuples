...
rwt.applyTauSFAndTTBarNorm("RW_Nominal", "RW_new_Nominal", norm_factor=norm_factor) # only do tau SF weight
for v in variations:
    rwt.applyTauSF(f"RW_{v}__1up", f"RW_new_{v}__1up")
    rwt.applyTauSF(f"RW_{v}__1down", f"RW_new_{v}__1down")
