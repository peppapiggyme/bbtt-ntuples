...
clos_mhh = TTbarTrueFakePlot(clos, "mHH", "weight_extra", (1800, 200000, 2000000), array.array(
    'd', [200000, 300000, 350000, 400000, 450000, 500000, 550000, 600000, 700000, 800000, 900000, 1000000, 1200000, 2000000]))
...
reweight1D(clos_mhh, "#M_{HH} [MeV]", f"plots/dRlh/clos_mhh_fr_os.pdf", "_mhh", drawOpt="HIST")
